                              ...
                              <repeater>
                                  <layout label="Text only">
                                      <table class="w580" width="580" cellpadding="0" cellspacing="0" border="0">
                                          <tbody><tr>
                                              <td class="w580" width="580">
                                                <p align="left" style="font-size: 18px; line-height:20px; color: #333333; font-weight:bold; margin-top:0px; margin-bottom:18px; font-family: "Helvetica Neue", Arial, Helvetica, sans-serif;"><singleline label="Title"><g:message code="enrollment.welcome1.label" /> ${user.nombre}</singleline></p>
                                                  <div align="left" class="article-content"> 
                                                      ...
                                                      <p label="Description"> <g:message code="enrollment.welcome7.label" /></p>
                                                      <p label="Description"> <g:message code="enrollment.welcome8.label" /></p>
                                                  </div>
                                              </td>
                                          </tr>
